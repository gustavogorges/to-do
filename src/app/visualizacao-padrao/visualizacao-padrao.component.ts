...
@Component({
  selector: 'app-visualizacao-padrao',
  templateUrl: './visualizacao-padrao.component.html',
  styleUrls: ['./visualizacao-padrao.component.css']
})
export class VisualizacaoPadraoComponent implements OnInit {
